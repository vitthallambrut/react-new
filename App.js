...
const resArr = [
    ...
    "availability": {
    "nextCloseTime": "2024-02-24 06:00:00",
    "opened": true
    },
    "badges": {},
    "isOpen": true,
    ...
    "availability": {
    "nextCloseTime": "2024-02-24 06:55:00",
    "opened": true
    },
    "badges": {
    "imageBadges": [
...
const RestaurantCard = (props) => {
    ...
    return (
            ...
            <img className="card-img" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} alt="image" />
        ...
        <div className="body">
            ...
            <div className="res-container">
            {
                resArr.map((resaurant)=> (
                    <RestaurantCard resData={resaurant} />
                ))
            }
             </div>
